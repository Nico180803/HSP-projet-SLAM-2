 ...
 */
final class Version20251028131802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenements ADD date_debut DATETIME NOT NULL, ADD date_fin DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenements DROP date_debut, DROP date_fin');
    }
}
